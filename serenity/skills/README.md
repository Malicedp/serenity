...
This directory contains built-in skills that extend serenity's capabilities.
...
When skills reference large local documentation or logs, prefer serenity's built-in
