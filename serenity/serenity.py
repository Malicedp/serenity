"""High-level programmatic interface to serenity."""
...
class Serenity:
    """Programmatic facade for running the serenity agent.

    Usage::

        bot = Serenity.from_config()
    ...
    def from_config(
        ...
        *,
        ...
        """Create a Serenity instance from a config file.
        ...
        """
        from serenity.config.loader import load_config, resolve_config_env_vars
        ...
        loop = AgentLoop(
            ...
            session_ttl_overrides=defaults.session_ttl_overrides,
            tools_config=config.tools,
            force_tool_use=defaults.force_tool_use,
        )
        return cls(loop)
