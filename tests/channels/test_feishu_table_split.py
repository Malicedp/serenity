...
table, allowing serenity to send multiple cards instead of failing.
"""

# Check optional Feishu dependencies before running tests
try:
    from serenity.channels import feishu
...
from serenity.channels.feishu import FeishuChannel
